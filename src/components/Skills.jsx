...
import {
  ...
  SiScikitlearn, // scikit-learn icon
} from "react-icons/si" // Imported from Simple Icons
...
const Skills = () => {
  return (
    <div className="max-w-4xl mx-auto flex flex-col justify-center px-4 text-gray-200 pb-8 md:py-12" id="skills">
        <Reveal>
        <h2 className="text-3xl font-bold mb-4 text-center">Skills</h2>
        <p className="text-center mb-8">
            I have worked on various frontend, fullstack, and machine learning projects. Check them <a href="#" className="underline">here</a>.
        </p>

        {/* Updated layout to use grid for better distribution */}
